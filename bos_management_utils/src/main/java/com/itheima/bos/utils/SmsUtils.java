...
public class SmsUtils {
    ...
    static final String accessKeyId = "LTAIDtqgY8ZHE05A";
    static final String accessKeySecret = "3a4h461xGBsxSJYd3L2wRjEsHGQEbN";
    ...
    public static SendSmsResponse sendSms(String telephone, String code)
        ...
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_115381077");
